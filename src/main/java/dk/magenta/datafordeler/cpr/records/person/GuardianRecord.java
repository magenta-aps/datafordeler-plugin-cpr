...
public class GuardianRecord extends PersonDataRecord {
    ...
    public List<CprBitemporality> getBitemporality() {
        ...
        bitemporalities.add(this.temporality);
    ...
    public Set<PersonEffect> getEffects() {
        ...
        effects.add(new PersonEffect(null, this.getOffsetDateTime("start_dt-umyndig"), this.getMarking("start_dt_umrk-umyndig"), this.getOffsetDateTime("slet_dt-umyndig"), false));
